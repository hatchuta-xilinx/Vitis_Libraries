...
void zlib_dm_rd(uintMemWidth_t* out,
                ...
                uint32_t readBlockSize,
                hls::stream<ap_axiu<kGMemDWidth, 0, 0, 0> >& outstream,
                hls::stream<ap_axiu<32, 0, 0, 0> >& sizestreamk) {
...
#pragma HLS dataflow
    streamDataK2dmSync<kGMemDWidth>(outstream512, outstream512_eos, readBlockSize, outsize_val, outstream, sizestreamk);
